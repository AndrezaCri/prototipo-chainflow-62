            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 gap-2">
                  <Button onClick={openSwapModal} className="flex items-center gap-2 p-3 bg-blue-50 hover:bg-blue-100 text-blue-800 border border-blue-200 rounded-lg" variant="ghost">
              ...
              <div className="flex gap-2">
                ...
                <Button onClick={handleClose} className="flex-1 bg-[#c1e428] hover:bg-[#a8c424] text-black">
                  Continuar
                </Button>
              </div>
            </div>
  ...
  return <>
      <Dialog open={isOpen} onOpenChange={handleClose}>
        <DialogContent className="sm:max-w-md">
          ...
          {authMethod === 'select' && <div className="space-y-4">
              ...
              <div className="space-y-3">
                {/* Login com Google */}
                <Button onClick={handleGoogleLogin} className="w-full flex items-center gap-3 p-4 border-2 border-blue-200 bg-blue-50 hover:bg-blue-100 text-blue-800 font-medium rounded-lg transition-colors" variant="ghost">
          ...
          {authMethod === 'email' && <div className="space-y-4">
              <div>
              ...
              <div className="flex gap-2">
                <Button onClick={() => setAuthMethod('select')} variant="outline" className="flex-1">
                  Voltar
                </Button>
                <Button onClick={handleEmailLogin} disabled={loading} className="flex-1 bg-[#c1e428] hover:bg-[#a8c424] text-black">
                  {loading ? <>
